...
public class DB {
    ...
    public ArrayList<CarDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CarDomain> playerList =  new ArrayList<CarDomain>();

        for(String jObjString : objStrings){
            CarDomain player  = gson.fromJson(jObjString,  CarDomain.class);
    ...
    public void putListObject(String key, ArrayList<CarDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CarDomain player: playerList){
